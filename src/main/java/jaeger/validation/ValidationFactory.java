...
import jaeger.content.ContentRepository;
...
//    }
//
//    void validateField(Validation.Builder validationBuilder, Field field,
...
//
//        String fieldName = Utility.fieldName(field, submissionData);
//
//        if (fieldName == null) {
...
//                isFileField = (field.getType().equals(FieldTag.FILE.getFieldType()) || field.getType().equals(FieldTag.URL.getFieldType()));
//                isDateField = (field.getType().equals(FieldTag.DATE.getFieldType()) || field.getType().equals(FieldTag.DATETIME.getFieldType())
//                        || field.getType().equals(FieldTag.DATETIME_LOCAL.getFieldType()));
//            }
//
//            if (isFileField) {
